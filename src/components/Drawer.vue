          ...
          <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white flex">
            ...
            <Popover>
              ...
              <template #context>
                ...
                <ul>
                  <li class="py-2">
                    <b>Вариант 1.</b> Вы вручную для каждой сделки определяете дату и время начала и завершения события, посредством заполнения полей amoCRM.
                    Например: 20.06.2023 15:00 - 20.06.2023 17:30
                  </li>
                  <li class="py-2">
                    <b>Вариант 2.</b> Вы назначаете дату и время начала события, а продолжительность уже будет фиксирована для всех событий.
