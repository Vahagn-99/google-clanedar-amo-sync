          ...
          <div class="dtc-activate__controls">
            ...
            <div class="dtc-activate__button">
              <button
                ...
                class="button-input"
                :class="{
                  'button-input-disabled': !userAggreed,
                }"
...
const { hasPhone, addPhone, subdomain } = useSubdomain();
...
const userAggreed = ref(false);
const currentCountryCode = ref(subdomain.value?.phone ?? "+7");
